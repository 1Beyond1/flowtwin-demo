...
export const AMAP_CACHE_TTLS = Object.freeze({
  // This is a review/demo deployment rather than a public navigation product.
  // Keep repeated route demonstrations off the upstream quota for an hour,
  // while the route endpoint still labels the longer stale fallback.
  route: 60 * 60 * 1000,
  poi: 24 * 60 * 60 * 1000,
